...
static const JSCFunctionListEntry js_imgui_funcs[] = {
     //JS_CFUNC_DEF("Get", 1, js_imguiDemoWindow),
        JS_CFUNC_DEF("ShowDemoWindow", 0, js_imguiDemoWindow),
        JS_CFUNC_DEF("Begin", 0, js_imgui_Begin),
        JS_CFUNC_DEF("End", 0, js_imgui_End),
        JS_CFUNC_DEF("Text", 1, js_imgui_Text),
        JS_CFUNC_DEF("Button", 2, js_imgui_Button),
        JS_CFUNC_DEF("Checkbox", 2, js_imgui_Checkbox),
        JS_CFUNC_DEF("Toggle", 2, js_imgui_Toggle),
        ...
        JS_CFUNC_DEF("IsItemDeactivatedAfterEdit", 0,js_imgui_IsItemDeactivatedAfterEdit),
        ...
        JS_CFUNC_DEF("GetMouseCursor", 0, js_imgui_GetMouseCursor),
        JS_CFUNC_DEF("GetForegroundDrawList", 0, js_imgui_GetForegroundDrawList),
        JS_CFUNC_DEF("GetIO", 0, js_imgui_GetIO),
};
