declare module "https://esm.sh/franc@6.2.0/es2022/franc.bundle.mjs"{
/**
 ...
 */
export function francAll(value?: string | undefined, options?: Options | undefined): Array<[string, number]>;
